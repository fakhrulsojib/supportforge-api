...
class ChatService:
    ...
    async def stream_message(
        ...
        system_prompt = (
            ...
            "- NEVER say things like 'Based on the provided documentation' or 'According to the context'. "
            "Just answer the question directly as the expert. You can mention specific policies naturally "
