...
class TenantCreateRequest(BaseModel):
    ...
    config_json: dict[str, str] | None = Field(None, description="Optional tenant configuration")
...
class TenantUpdateRequest(BaseModel):
    ...
    config_json: dict[str, str] | None = Field(None, description="Updated configuration")
...
class TenantResponse(BaseModel):
    ...
    config_json: dict[str, str] | None = Field(None, description="Tenant configuration")
